       ...
       for panel in all_panels:
        #    Remove images from panel since they're not locally saved
           ...
           for a_tag in panel_body.find_all('a', class_='qTipCourse'):
            ...
            #    Filter out any qTipCourses which are either Workterms (WKT) or are used as notes (usually enclosed in small tags on the website) since we do not want to put a checkbox next to these
